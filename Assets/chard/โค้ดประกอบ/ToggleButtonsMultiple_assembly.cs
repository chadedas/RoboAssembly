...
public class ToggleButtonsMultiple_assembly : MonoBehaviour
{
    public static ToggleButtonsMultiple_assembly Instance;
    ...
    void ActivateButton(int activeIndex)
    {
        ...
        CentralScript_assembly.Instance.ReceiveButtonNumber(ToolsNumber); // ส่ง ToolsNumber
    }
