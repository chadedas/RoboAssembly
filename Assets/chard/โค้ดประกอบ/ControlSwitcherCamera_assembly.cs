...
public class ControlSwitcherCamera_assembly : MonoBehaviour
{
    [SerializeField]
...
int stack3;
    ...
    private void Update()
    {
        ...
        if (CentralScript_assembly.Instance != null)
        {
            currentStep = CentralScript_assembly.Instance.GetCurrentStep();
            stack1 = CentralScript_assembly.Instance.GetStack1();
            stack2 = CentralScript_assembly.Instance.GetStack2();
            stack3 = CentralScript_assembly.Instance.GetStack3();
        }
        else
        {
        ...
        if (Input.GetKeyDown(KeyCode.C))
        {
            ...
            CentralScript_assembly.Instance.SetActiveState(active);
            if(currentStep >= 100)
            {
